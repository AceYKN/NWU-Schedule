...
| Android 构建 | [GitHub Actions Run #189](https://github.com/AceYKN/NWU-Schedule/actions/runs/35531885939)：debug/release APK 与 merged manifest 校验 | PASS |

最近一次本地全量检查：格式、校历校验、隐私校验、DOM fixture、`flutter analyze`、174 项 `flutter test` 均通过。Run #189 以当前 `main` 提交 `9ac7c95` 完成全部 CI 检查，包括 debug/release APK 构建与最终 merged manifest 校验。
