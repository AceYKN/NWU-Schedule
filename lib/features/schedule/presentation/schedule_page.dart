...
class _SchedulePageState extends ConsumerState<SchedulePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final currentWeek = engine.calendarEngine.weekOf(CampusClock.now()) ?? 1;
    final week = selectedWeek ?? currentWeek;
    return FutureBuilder<List<EffectiveCourseInstance>>(
      future: engine.getCoursesForWeek(week),
      ...
      children: [
        Row(
          children: [
            ...
            IconButton(
              tooltip: '下一周',
              onPressed: week < 20 ? () => onWeekChanged(week + 1) : null,
